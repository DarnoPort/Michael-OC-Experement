...
## Текущий этап — Phase 24

Phase 24 продолжает постепенное приближение интерфейса Michael OS к классическому DOS-подобному терминалу. После `DIR /W` и `HELP <command>` shell получает базовую операцию копирования файлов — `COPY`.
