...
## Текущий этап — Phase 24.4

Phase 24.4 остаётся внутри направления файловых операций Phase 24: `MOVE` теперь умеет принимать существующий каталог назначения и автоматически перемещать объект внутрь него с сохранением исходного имени. Это небольшая подфаза без изменения модели процессов или syscall ABI.
