...
## Текущий этап — Phase 20

Юбилейная фаза 0.20 приводит версию Michael OS к единому источнику: GRUB, стартовый экран и команда ver теперь получают одну и ту же версию автоматически.
